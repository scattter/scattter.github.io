import{_ as n,o as a,c as p,a3 as e}from"./chunks/framework.d6OaePA7.js";const d=JSON.parse('{"title":"前端部署方案","description":"","frontmatter":{},"headers":[],"relativePath":"pages/explore/frontend/前端项目部署方案.md","filePath":"pages/explore/frontend/前端项目部署方案.md","lastUpdated":1693917276000}'),l={name:"pages/explore/frontend/前端项目部署方案.md"};function i(r,s,c,t,b,o){return a(),p("div",null,[...s[0]||(s[0]=[e(`<h1 id="前端部署方案" tabindex="-1">前端部署方案 <a class="header-anchor" href="#前端部署方案" aria-label="Permalink to &quot;前端部署方案&quot;">​</a></h1><h2 id="一-触发方式" tabindex="-1">一. 触发方式 <a class="header-anchor" href="#一-触发方式" aria-label="Permalink to &quot;一. 触发方式&quot;">​</a></h2><h3 id="_1-1-自动触发" tabindex="-1">1.1 自动触发 <a class="header-anchor" href="#_1-1-自动触发" aria-label="Permalink to &quot;1.1 自动触发&quot;">​</a></h3><p>使用<code>Jenkins/Gitlab runner</code> 等仓库监控工具去设置触发条件, 触发后执行开发自己设置的相应脚本, 如下面是我之前设置的一个gitlab脚本, 该脚本只对 <code>feature/zk</code> 分支生效, 即如果该分支有合入或者推送就会触发下面的命令, 替换Nginx的静态资源</p><blockquote><p>后面会补充gitlab runner的相关部署经历</p></blockquote><div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>image: node:14.7.0</span></span>
